New-Item -ItemType Directory -Force -Path 'src\app\shop\video-nadzor' | Out-Null
@'
...
export default async function VideoNadzorPage() {
  ...
  return (
    <div className="vn-page">
      <h1 className="vn-h1">Video nadzor — sistemi za zastitu</h1>
      ...
      <div className="vn-seo">
        ...
        <p>IT Security je specijalizovana firma za prodaju i ugradnju sistema video nadzora u Beogradu od 2008. godine. Nudimo kompletno resenje — od savetovanja i projektovanja, preko nabavke opreme, do profesionalne ugradnje i servisa. Sva oprema dolazi sa garancijom 2 do 3 godine.</p>
        ...
        <div className="vn-features">
          <div className="vn-feature">
            ...
            <p>Hikvision, Dahua, Uniview, TVT — originalna oprema sa garancijom</p>
          </div>
          <div className="vn-feature">
            <span className="vn-feature__icon">🔧</span>
          ...
          <div className="vn-feature">
            ...
            <p>Tehnicka podrska dostupna 7 dana u nedelji — 063224651</p>
          </div>
        </div>
      </div>
...
'@ | Set-Content -Path 'src\app\shop\video-nadzor\page.tsx' -Encoding UTF8
