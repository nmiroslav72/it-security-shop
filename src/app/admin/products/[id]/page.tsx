        ...
        <div className="pf-grid">
          ...
          <div className="pf-col">
            ...
            <div className="pf-card">
              ...
              <label className="pf-label">URL adrese slika (jedna po liniji)
                <textarea name="images" className="pf-textarea" rows={6}
                  defaultValue={product.images.join("\n")} />
              </label>
              <p className="pf-hint">Slike iz public/uploads/ unosite kao /uploads/2023/01/naziv.jpg</p>
            </div>
          </div>
