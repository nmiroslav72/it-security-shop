...
export const metadata: Metadata = {
  title: "Sigurno placanje — IT Security video nadzor",
  description: "Vise nacina placanja — pouzecem, uplatom na racun ili karticom. Sigurna kupovina opreme za video nadzor uz garanciju zadovoljstva.",
};
  ...
  return (
    <div className="sp-page">
      <nav className="sp-breadcrumb">
        ...
        <span>/</span>
        <span>Sigurno placanje</span>
      </nav>

      <h1 className="sp-h1">Sigurno placanje — vise nacina plaćanja</h1>

      <div className="sp-intro">
        <p>IT Security nudi vise nacina placanja kako bi kupovina bila sto laksa i sigurnija. Sve transakcije su zasticene, a robu placate tek kada je preuzmete.</p>
      </div>
      ...
      <div className="sp-grid">
        <div className="sp-item">
          ...
          <h2>Pouzecem</h2>
          <p>Placate gotovinom dostavljacu pri preuzimanju robe. Najsigurniji nacin — placate samo ono sto vidite.</p>
        </div>
        <div className="sp-item">
          <span className="sp-icon">🏦</span>
          <h2>Uplata na racun</h2>
          <p>Posaljemo vam predracun emailom, a robu isporucujemo nakon sto uplata stigne na nas racun.</p>
        </div>
        <div className="sp-item">
          <span className="sp-icon">🔒</span>
          <h2>Zasticena kupovina</h2>
          <p>Sve transakcije su zasticene. Vasi licni podaci se koriste samo za isporuku i nikada se ne dele trецim licima.</p>
        </div>
        <div className="sp-item">
          <span className="sp-icon">🧾</span>
          <h2>Fiskalni racun</h2>
          <p>Za svaku kupovinu izdajemo fiskalni racun koji je osnov za ostvarivanje prava na garanciju.</p>
        </div>
      </div>
